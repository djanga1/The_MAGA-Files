...
export const AnalysisDashboard: React.FC<AnalysisDashboardProps> = ({ onAnalyze, isLoading, onChangeSource }) => {
  ...
  return (
    <div className="w-full max-w-3xl flex flex-col gap-8">
      <div className="bg-slate-900/50 p-6 rounded-lg border border-slate-700 shadow-2xl shadow-fuchsia-500/10">
        <div className="flex justify-between items-start mb-4">
          <h2 className="text-2xl font-bold text-slate-100">Analysis Console</h2>
          <button
            onClick={onChangeSource}
            className="text-sm bg-slate-700 hover:bg-slate-600 text-slate-300 font-medium py-2 px-4 rounded-md transition-colors duration-200"
          >
            Change Data Source
          </button>
        </div>
