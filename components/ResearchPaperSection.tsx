...
export const ResearchPaperSection: React.FC = () => {
    return (
        <section className="bg-slate-900/50 border border-slate-700 rounded-lg p-8">
            <div className="text-center">
                <h2 className="text-3xl font-bold text-slate-100 mb-2">The Foundational Research</h2>
                <p className="text-slate-400 mb-6 text-lg">MAGA: The Covert Call for Colonialism’s Comeback</p>
            </div>
